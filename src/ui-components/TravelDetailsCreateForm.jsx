...
export default function TravelDetailsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new TravelDetails(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "TravelDetailsCreateForm")}
      {...rest}
    >
      <TextField
        label="Departure"
