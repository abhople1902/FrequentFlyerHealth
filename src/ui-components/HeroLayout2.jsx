...
export default function HeroLayout2(props) {
  ...
  const variants = [
    {
      overrides: {
        "Flight, health and convenience": {},
        "Calculate your FrequentFlyerHealthIndex on fly": {},
    ...
    >
      ...
      >
        <Text
          ...
          {...getOverrideProps(overrides, "Flight, health and convenience")}
        ></Text>
        <Flex
          gap="16px"
          direction="column"
